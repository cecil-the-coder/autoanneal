...
Read the error messages carefully, identify the root cause in the allowed files, and apply the minimal fix to resolve each error. After fixing, re-run the build command to verify the errors are resolved."#;
